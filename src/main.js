...
const renderSiteFilmsBoard = function () {
...
const renderSiteFilmCard = function (container, data) {
...
const renderSiteFilmsCard = function (container, data) {
  data.forEach((it) => {
    renderSiteFilmCard(container, it);
  });
};
...
const renderSiteLoadMoreButton = function (container) {
  ...
  render(container, createShowMoreButton(), `beforeEnd`);
};

const renderSiteFilmsExtraBoard = function (container) {
  ...
  render(container, createFilmsExtraBoards(`Top rated`), `beforeEnd`);
  render(container, createFilmsExtraBoards(`Most commented`), `beforeEnd`);
};

const renderSiteFilmDetailsPopup = function () {
...
const init = function () {
  ...
  renderSiteMenu();
  renderSiteSort();
  renderSiteFilmsBoard();

  const filmsList = main.querySelector(`.films-list`);
  const filmsElement = main.querySelector(`.films`);
  const filmsListContainer = filmsList.querySelector(`.films-list__container`);

  renderSiteFilmsCard(filmsListContainer, filmsData);
  renderSiteLoadMoreButton(filmsList);
  renderSiteFilmsExtraBoard(filmsElement);
  ...
  renderSiteFilmsCard(topRatedContainer, filmsTopRatedData);
  renderSiteFilmsCard(mostCommentsContainer, filmsMostCommentedData);

  renderSiteFilmDetailsPopup();
};
